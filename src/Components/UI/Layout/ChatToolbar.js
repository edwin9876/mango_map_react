    ...
    <div>
      <nav>
        <div className='d-flex justify-content-between margin5'>
          ...
          {' '}
          <i className='material-icons gray70' onClick={toggle}>person_add{buttonLabel}</i>
          </Form>
          <Modal isOpen={modal} toggle={toggle} className={className} unmountOnClose={unmountOnClose}>
              ...
              <ModalBody>
                  <Input type="textarea" placeholder="Find with username" rows={1} />
              ...
              <ModalFooter  className="d-flex justify-content-center" >
                  <Button color="success" onClick={toggle}>Add User</Button>{' '}
              </ModalFooter>
          </Modal>
          </div>
