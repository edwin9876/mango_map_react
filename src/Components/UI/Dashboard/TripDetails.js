    ...
    return (
      ...
      >
        ...
        <i
          ...
          className="material-icons gray50"
        >
          arrow_back
        </i>
        ...
        <Card style={{ background: theme.low, borderColor: theme.high }}>
          <CardBody>
            <CardTitle className="bold justify-content-center d-flex">
              Trip to {this.state.location.en} {this.state.location.cn}
            </CardTitle>

            <CardSubtitle className=" justify-content-center d-flex">
              {" "}
              Group1, {this.state.location.created_at}
            </CardSubtitle>
            <br />

            {this.state.location.images &&
              this.state.location.images.map((img, i) => {
                return (
                  <div key={i}>
                    <CardImg
                      top
