    ...
    return (
      <div>
        <div className="margin5">
          ...
          <Select
            defaultValue={
              label && value ? { label: label, value: value } : undefined
            }
        ...
        >
          ...
          <FormGroup>
            <Label for="exampleSelectMulti" className="bold">
              Choose Category<span className="light">(select 1 or more)</span>
            </Label>
            <Input
              style={{
                background: theme.low,
          ...
          <FormGroup>
            ...
            <Input
              ...
              type="textarea"
              name="body"
              placeholder="Please write contents here"
              rows="10"
            />
          </FormGroup>

          <FormGroup>
            <Label for="exampleFile" className="bold">
              Pictures
            </Label>
            <Input
