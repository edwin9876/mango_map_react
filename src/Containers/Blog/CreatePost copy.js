  ...
  return (
    <div id="Post_container" style={{ background: theme.low, color: theme.high }}>
      ...
      <ButtonGroup className="d-flex justify-content-center paddingy1">
        <Button style={{ background: theme.low, color: theme.high, borderColor: theme.low }}> <i className="material-icons">create</i></Button>
        <Button style={{ background: theme.low, color: theme.high, borderColor: theme.low }}> <i className="material-icons">add_a_photo</i></Button>
      </ButtonGroup>
